...
Student Name: Parami Athukorala
Student ID: 20241190
UoW ID: 21213245
...
curl -X POST http://localhost:8080/smart-campus-api/api/v1/rooms \
     ...
     -d '{"id": "ROOM-404", "name": "Library", "capacity": 30}'

3. Retrieve a Specific Room (GET)
curl -X GET http://localhost:8080/smart-campus-api/api/v1/rooms/ROOM-404

4. Register a Sensor (POST)
curl -X POST http://localhost:8080/smart-campus-api/api/v1/sensors \
     -H "Content-Type: application/json" \
     -d '{"id": "SN-1", "type": "CO2", "status": "ACTIVE", "roomId": "ROOM-404"}'

5. Filter Sensors by Type (GET)
curl -X GET "http://localhost:8080/smart-campus-api/api/v1/sensors?type=CO2"

6. Delete an Empty Room (DELETE)
curl -i -X DELETE http://localhost:8080/smart-campus-api/api/v1/rooms/EMPTY-RM
